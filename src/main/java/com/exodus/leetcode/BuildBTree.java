...
import com.exodus.fundamentals.binarytree.TreeNode;

/**
 * @author arhaiyun
 * @date 2020/5/22 10:05 PM
 */
...
public class BuildBTree {
  ...
  public TreeNode myBuildTree(int[] preorder, int[] inorder, int preorder_left, int preorder_right,
    ...
    root.right =
        myBuildTree(preorder, inorder, preorder_left + size_left_subtree + 1, preorder_right,
